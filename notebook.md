...
- [Flutter Notes](#flutter-notes)
  ...
  - [Defintions with Structures](#flutter-definitions-with-structures)
...
//see flutter guided notes in canvas to complete table
...
//see flutter definitions in canvas to complete table terms. For real life, think of examples, research and/or use AI to assist, for app examples, explore firebase app, ask for help if needed
...
//see coding definitions in canvas to complete table terms. For real life, think of examples, research and/or use AI to assist, for app examples, explore firebase app, ask for help if needed
